    ...
    protected void convert(final BaseViewHolder helper, MultiItemEntity item)
    {
       switch (helper.getItemViewType())
       {
           case TYPE_PARENT:
           {
               ...
               helper.setTextColor(R.id.item_mainjcfragment_condition_parent_tv,departmentDeviceVosBean.isSelected() ? ContextCompat.getColor(mContext,R.color.white): ContextCompat.getColor(mContext,R.color.colorPrimary));
