package company.petrifaction.client.adapter.lsbj;
    ...
    protected void convert(final BaseViewHolder helper, MultiItemEntity item)
    {
       switch (helper.getItemViewType())
       {
           case TYPE_PARENT:
           {
               ...
               helper.setTextColor(R.id.item_mainbjfragment_condition_parent_tv,departmentBean.isSelected() ? ContextCompat.getColor(mContext,R.color.white): ContextCompat.getColor(mContext,R.color.colorPrimary));
